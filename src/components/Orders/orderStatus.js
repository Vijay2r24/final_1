...
const YourComponent = ({ onBack, onNext, orderId }) => {
    ...
    const fileReadPromises = selectedFiles.map((file, index) => {
      return new Promise((resolve, reject) => {
        ...
        reader.onload = () => {
          ...
          console.log(`Binary data read for: ${file.name}, type: ${file.type}`);
  ...
  const fetchOrderDetails = async () => {
    try {
      ...
      console.log("Mapped Status Details:", statusDetails);
      console.log("SubStatusId from Status Details:", statusDetails.map(item => item.SubStatusId));
                  ...
                  {filteredStatusList.map((status, index) => (
                    ...
                    >
                      ...
                      >
                        ...
                        {/* Status Text */}
                        {console.log('Status Object:', subStatusId)} {/* Log the entire status object */}
                        {console.log('SubStatusId:', statusDetails.map(item => item.SubStatusId))} {/* Log SubStatusId separately using map */}
